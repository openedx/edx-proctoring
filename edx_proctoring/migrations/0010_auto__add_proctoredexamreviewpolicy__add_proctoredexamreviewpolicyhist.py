...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProctoredExamReviewPolicy'
        db.create_table('proctoring_proctoredexamreviewpolicy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('set_by_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('proctored_exam', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edx_proctoring.ProctoredExam'])),
            ('review_policy', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('edx_proctoring', ['ProctoredExamReviewPolicy'])

        # Adding model 'ProctoredExamReviewPolicyHistory'
        db.create_table('proctoring_proctoredexamreviewpolicyhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('original_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('set_by_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('proctored_exam', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edx_proctoring.ProctoredExam'])),
            ('review_policy', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('edx_proctoring', ['ProctoredExamReviewPolicyHistory'])

        # Adding field 'ProctoredExamStudentAttemptHistory.review_policy_id'
        db.add_column('proctoring_proctoredexamstudentattempthistory', 'review_policy_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'ProctoredExamStudentAttempt.review_policy_id'
        db.add_column('proctoring_proctoredexamstudentattempt', 'review_policy_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProctoredExamReviewPolicy'
        db.delete_table('proctoring_proctoredexamreviewpolicy')

        # Deleting model 'ProctoredExamReviewPolicyHistory'
        db.delete_table('proctoring_proctoredexamreviewpolicyhistory')

        # Deleting field 'ProctoredExamStudentAttemptHistory.review_policy_id'
        db.delete_column('proctoring_proctoredexamstudentattempthistory', 'review_policy_id')

        # Deleting field 'ProctoredExamStudentAttempt.review_policy_id'
        db.delete_column('proctoring_proctoredexamstudentattempt', 'review_policy_id')
