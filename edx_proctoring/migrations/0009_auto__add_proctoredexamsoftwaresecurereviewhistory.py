...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProctoredExamSoftwareSecureReviewHistory'
        db.create_table('proctoring_proctoredexamsoftwaresecurereviewhistory', (
        ...
        db.send_create_signal('edx_proctoring', ['ProctoredExamSoftwareSecureReviewHistory'])


    def backwards(self, orm):
        # Deleting model 'ProctoredExamSoftwareSecureReviewHistory'
        db.delete_table('proctoring_proctoredexamsoftwaresecurereviewhistory')
