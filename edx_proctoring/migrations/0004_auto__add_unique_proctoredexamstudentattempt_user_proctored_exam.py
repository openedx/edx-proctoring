...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProctoredExamStudentAttempt', fields ['user', 'proctored_exam']
        db.create_unique('proctoring_proctoredexamstudentattempt', ['user_id', 'proctored_exam_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProctoredExamStudentAttempt', fields ['user', 'proctored_exam']
        db.delete_unique('proctoring_proctoredexamstudentattempt', ['user_id', 'proctored_exam_id'])
