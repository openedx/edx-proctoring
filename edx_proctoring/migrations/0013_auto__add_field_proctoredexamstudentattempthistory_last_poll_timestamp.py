...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProctoredExamStudentAttemptHistory.last_poll_timestamp'
        db.add_column('proctoring_proctoredexamstudentattempthistory', 'last_poll_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ProctoredExamStudentAttemptHistory.last_poll_ipaddr'
        db.add_column('proctoring_proctoredexamstudentattempthistory', 'last_poll_ipaddr',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProctoredExamStudentAttemptHistory.last_poll_timestamp'
        db.delete_column('proctoring_proctoredexamstudentattempthistory', 'last_poll_timestamp')

        # Deleting field 'ProctoredExamStudentAttemptHistory.last_poll_ipaddr'
        db.delete_column('proctoring_proctoredexamstudentattempthistory', 'last_poll_ipaddr')
