...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProctoredExamSoftwareSecureComment'
        db.create_table('proctoring_proctoredexamstudentattemptcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('review', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edx_proctoring.ProctoredExamSoftwareSecureReview'])),
            ('start_time', self.gf('django.db.models.fields.IntegerField')()),
            ('stop_time', self.gf('django.db.models.fields.IntegerField')()),
            ('duration', self.gf('django.db.models.fields.IntegerField')()),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('edx_proctoring', ['ProctoredExamSoftwareSecureComment'])

        # Adding model 'ProctoredExamSoftwareSecureReview'
        db.create_table('proctoring_proctoredexamsoftwaresecurereview', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('attempt_code', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('review_status', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('raw_data', self.gf('django.db.models.fields.TextField')()),
            ('video_url', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('edx_proctoring', ['ProctoredExamSoftwareSecureReview'])


    def backwards(self, orm):
        # Deleting model 'ProctoredExamSoftwareSecureComment'
        db.delete_table('proctoring_proctoredexamstudentattemptcomment')

        # Deleting model 'ProctoredExamSoftwareSecureReview'
        db.delete_table('proctoring_proctoredexamsoftwaresecurereview')
